    ...
    <article class="a2">
      <ul>
        <li v-for="item in msgList"
          ...
          <div class="parent">
            <div class="left"
                 :style="{backgroundImage: `url(${baseURL}${item.author.photo})`}"></div>
            <div class="right">
              <div class="name-time">
          ...
          <div class="child"
               ...
               :key="childItem._id">
            <div class="left"
                 :style="{backgroundImage: `url(${baseURL}${childItem.author.photo})`}"></div>
            <div class="right">
              <div class="name-time">
              ...
              <div class="like-reply">
                <i class="like iconfont icon-xinaixin"
                   ...
                   @click="childLikeClick(item._id, childItem._id, index)"></i>
                <span>{{ childItem.likes.length }}</span>
                <i class="reply iconfont icon-huifu"
                   @click="childReplyClick(item,childItem)"></i>
              </div>
            </div>
          </div>
          <div class="replyInput"
            ...
            <el-input size="mini"
                      ...
                      v-model="item.replyTxt"></el-input>
            <el-button type="primary"
                       size="mini"
                       @click="replySubmit(item)">提交
            </el-button>
          </div>
        </li>
      </ul>
