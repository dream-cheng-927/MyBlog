<template>
  <div id="Home">
    ...
    <article class="hello">
      <h2>HELLO!</h2>
      <p class="des">
        你好！欢迎来到我的博客！我是一名有点肾虚的WEB前端攻城狮，热衷于研究Html+CSS、JavaScript、NodeJs、Vue、React……这是我的主页！
        我会在这里发表一些不成熟的技术文章，记录一些沙雕的日常。博客目前使用的是Vue+ Nuxt + Element + Node + Express + MongoDB搭建的，如果对源码感兴趣的话可以
        <a href="https://github.com/dream-cheng-927/git-demo"
           target="_blank">点击这里</a>。欢迎提出宝贵的建议哦！
      </p>
      <div class="info">
        <div class="personal">
          ...
          <ul>
            ...
            <li>
              <p>EMAIL</p>
              <p>2539186615@qq.com</p>
            </li>
            <li>
              <p>GITHUB</p>
              <p><a href="https://github.com/dream-cheng-927"
                   target="_blank">https://github.com/dream-cheng-927</a></p>
            </li>
          </ul>
        </div>
        <div class="skills">
      ...
      <div class="content"
        ...
        <div class="left">
          <div class="art">
            ...
            <div class="cover">
              <a :href="`/article/${hotArticle[0]._id}`"
                 target="_blank">
                <p>Tag: HTML</p>
                <p>View More</p>
              </a>
          ...
          <div class="art">
            <img src="../assets/img/article/3.jpg"
                 alt="">
            <p>{{hotArticle[1].title}}</p>
            <div class="cover">
              <a :href="`/article/${hotArticle[1]._id}`"
                 target="_blank">
                <p>Tag: HTML</p>
                <p>View More</p>
              </a>
        ...
        <div class="right">
          <div class="art">
            <img src="../assets/img/article/2.jpg"
                 alt="">
            <p>{{hotArticle[2].title}}</p>
            <div class="cover">
              <a :href="`/article/${hotArticle[2]._id}`"
                 target="_blank">
                <p>Tag: HTML</p>
                <p>View More</p>
              </a>
